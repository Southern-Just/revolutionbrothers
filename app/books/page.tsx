...
export default function ComingSoon() {
  ...
  return (
      <div className="min-h-screen flex items-start justify-center mt-24 overflow-hidden relative bg-white">
        ...
        <div className="relative z-10 backdrop-blur-3xl bg-white/60 border border-black/5 rounded-3xl px-10 py-8 shadow-[0_20px_60px_rgba(0,0,0,0.08)] text-center transition-all duration-700 [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] hover:scale-[1.02]">
